...
3. 어휘 수준 의도적 하향
    - 한자어/고급 표현을 순우리말로 교체
    - 5~10어절마다 "어쩌면", "주도적인", "객관적인", "실질적인", "명확한", "유의미한", "효율적인", "독창적인", "추가적으로", "주도적으로", "객관적으로", "주관으로", "실질적으로", "다방면에서", "명확하게", "전략적으로", "효율적으로" "꾸준히" "끊임없이" "적극적으로" "성공적으로" "묵묵히" "따라서" "그러므로" "결론적으로" "종합적으로" 중에서 부사 삽입

...
4. 흐름 꺾기 (단순 권고문 톤 회피 — 가장 중요. 안 지키면 디텍터 직격)
   ...
   - ★ 글 전체 "행위 → 좋은 결과" 사이클 4회+ 반복 절대 금지 (카피킬러 핵심 시그너처): "X했더니 좋아졌습니다 / Y했더니 늘었습니다 / Z했더니 정리됐습니다"식 권고-효과 사이클이 4번 이상 이어지면 즉시 잡힌다. 3번째 이후로는 반드시 결과가 *아닌* 패턴으로 끊어라:
     · 결과 회의: "Y는 의외로 큰 차이가 없었습니다" / "Z는 효과가 있는지 아직 잘 모르겠습니다"
     · 시도 실패: "W를 해봤지만 결국 안 맞았습니다" / "처음엔 좋다 싶었는데 일주일 만에 흐지부지됐습니다"
     · 의문 끼어들기: "그런데 정말 이게 효과 때문인지, 아니면 그냥 컨디션 좋은 날이라 그런 건지 헷갈렸습니다"
     · 다른 각도 점프: "사실 방법보다 그날의 기분이 더 영향이 큰 것 같기도 합니다"

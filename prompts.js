...
2. 문장 길이 + 한 문장 한 사실
   ...
   - 8자 이하 초단문 2개+ ("그게 전부였습니다.", "숫자가 말해줍니다.")
   - 한 문장 = 한 사실. 정보 둘 셋을 매끄럽게 묶어 잇지 말 것.
     · 금지: "스마트폰을 서랍에 넣고 알림을 끄고 음악을 틀었더니 집중이 늘었습니다."
     · 권장: "스마트폰은 서랍에 넣었습니다. 알림도 다 껐습니다. 흐름이 안 끊겼습니다."

3. 어휘 수준 의도적 하향
   - 한자어/고급 표현은 순우리말로 ("봉착하다" → "부딪히다", "상이하다" → "다르다")
   - 5~10어절마다 부사 불규칙 삽입: "사실", "막상", "솔직히", "생각보다", "결국", "오히려", "제대로", "의외로", "꽤", "꾸준히", "어떻게든", "확실히"

4. 흐름 꺾기 (단순 권고문 톤 회피 — 가장 중요. 안 지키면 디텍터 직격)
   - 반전 한정어 1개+ 필수: "다만", "오히려", "그런데도", "사실은", "막상", "도리어"
   - 자기 부정·한계 고백 1줄 필수: "그걸 인정하는 데도 시간이 걸렸습니다", "솔직히 처음엔 이게 맞나 싶었습니다"
   - 메타 사색 1줄 필수 (권장 아님 — 없으면 디텍터 잡힘): 방법론 나열 끝에 한 단계 위로 점프하는 통찰. "어쩌면 ~보다 ~에 가까운 문제인지도 모릅니다" / "남들이 효과 봤다는 게 나한테는 안 맞을 수도 있습니다" / "결국 정답은 사람마다 다른 것 같습니다" 류. 단순 "~것 같습니다" hedging은 메타 사색이 아님 — 진짜 한 차원 위로 점프해야 한다.
   - ★ 글 전체 "행위 → 좋은 결과" 사이클 4회+ 반복 절대 금지 (카피킬러 핵심 시그너처): "X했더니 좋아졌습니다 / Y했더니 늘었습니다 / Z했더니 정리됐습니다"식 권고-효과 사이클이 4번 이상 이어지면 즉시 잡힌다. 3번째 이후로는 반드시 결과가 *아닌* 패턴으로 끊어라:
     · 결과 회의: "Y는 의외로 큰 차이가 없었습니다" / "솔직히 효과인지 그냥 익숙해진 건지 헷갈립니다" / "Z는 효과가 있는지 아직 잘 모르겠습니다"
     · 시도 실패: "W를 해봤지만 결국 안 맞았습니다" / "처음 일주일은 좋았는데 그 뒤로는 흐지부지됐습니다" / "처음엔 좋다 싶었는데 일주일 만에 흐지부지됐습니다"
     · 의문 끼어들기: "그런데 정말 이게 효과 때문일까 싶기도 했습니다" / "이게 누구한테나 통하는 방법인지는 잘 모르겠습니다" / "정말 이게 효과 때문인지, 아니면 그냥 컨디션 좋은 날이라 그런 건지 헷갈렸습니다"
     · 다른 각도 점프: "방법보다 그날의 컨디션이 더 큰 변수였던 것 같기도 합니다" / "결국 이건 기술이 아니라 자기 패턴을 읽어내는 문제 같습니다" / "사실 방법보다 그날의 기분이 더 영향이 큰 것 같기도 합니다"
   - 권고-효과 인과 ("~면 ~했습니다", "~더니 ~했습니다", "~으로 ~했습니다") 3회+ 반복 금지. 3번째부터는 골격 변형: "정해두니까 덜 허탈했습니다" / "정해두는 게 차이가 컸습니다"

5. 종결 어미 다양성
   - 기본 ~입니다/~합니다/~했습니다 존댓말. "~요", "~이다", "~한다" 금지.
   - "~었습니다/~했습니다"가 5문장 이상 연속이면 "~거든요", "~인지도 모릅니다", "~던 것 같습니다", "~기도 했습니다" 중 하나로 자연스러울 때 끊어라.
   - 추정형 "~인 것 같습니다", "~던 것 같습니다" 전체의 10~15%

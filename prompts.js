...
5. 어미 형식 통일 + 종결 다양화
   ...
   - 같은 종결어미(습니다/됩니다/있습니다) 3문장 연속 금지 — 3번째는 의문형(~까요?)/추정형/경험형("느꼈습니다/보았습니다")으로 끊어라
   - 의문문 최소 1개: "정말 ~일까요?" 같이 주장 중 하나를 열어둔다
...
7. 한국어 자연스러움 필수 규칙 (GPT Killer 대응)
   ...
   - 구체 디테일 2종 이상 필수:
     · 시점: "지난 학기", "수업 3주 차", "중간고사 직전", "발표 전날 밤"
     · 수치: "조원 4명", "발표 12분", "자료 30페이지", "3주 동안"
     · 감각: "손에 땀이 찼습니다", "머릿속이 하얘졌습니다", "목이 쉬었습니다", "심장이 뛰었습니다"
...
- 분량: 원문 대비 95~115% 엄수. 축약 금지, 과도한 증식 금지.
- 핵심 가치: 읽었을 때 '과제를 진지하게 쓴 학부생 글' 느낌. 지나친 구어체/SNS 톤 금지, 경직된 학술 어투도 금지.`,

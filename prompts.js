...
═══════════════════════════════════════
★★ TOP-4 시그너처 — 매 문장 쓰기 전 검사 (가장 자주 위반, 100% 검출의 직접 원인) ★★

[T1] 종결어미 균질 박살내기
  - ~습니다/~었습니다/~했습니다/~입니다/~겁니다 — 4문장 연속 X.
  - 매 3~4번째 문장은 변형 1종 삽입: "~것 같다(한 글 ≤1회)/~인지도 모른다/~기도 하다/~까?(의문)/짧은 평서". 4종+ 골고루 X(시그너처).
  - A는 ~합니다체, B는 ~다체. 한 글에서 두 체 혼용 X.

[T2] 명사 주어 분산
  - 인접 3문장 모두 명사 주어("X은/는/이/가...") 시작 X.
  - 매 3번째 문장은 부사("결국/사실/막상/오히려") 또는 접속사("다만/그런데") 또는 지시어("그게/이건") 시작.

[T3] 수동 종결 ≤25%
  - "~된다/~되었다/~형성된다/~설계된다/~이루어진다/~제기된다/~쏟아진다" → 능동 동사 교체:

...
'따라서', '그러므로', '즉', '결국', '결론적으로', '궁극적으로' 같은 접속사를 70% 이상 줄여라. 특히 "결국", "결론적으로"는 전체에서 각 1회 이하로 제한.
...
글의 주제어(원문에 가장 많이 나오는 명사, 예: "AI", "일자리", "개발자", "모델")가 전체에서 4회 이상 등장하지 않도록 하라. 3회째부터는 지시어("그것", "이 쪽 일") 또는 유의어로 반드시 치환하라. 출력 전 주제어 횟수를 직접 세어 검증할 것.
...
하나라도 기준 미달이면 해당 부분 재작성 후 다시 실측. 전부 통과해야 JSON 출력.

...
3. 의태어/부사 삽입: "확", "푹", "슬쩍", "대충", "싹", "툭" 중 2~3개를 자연스러운 위치에
4. 콤마·중점 나열 강력 제한 (GPT Killer 최대 탐지 패턴):
   - 3개 이상 항목을 ',' 또는 '·'로 나열 절대 금지. 최대 2개까지 "A와 B"로 묶기.
   - 3개 이상 표현 시 1개로 대표하거나 문장 분리
     (X) "수학·통계·자료구조 같은 기본기"
     (O) "수학 같은 기본기" 또는 "수학부터 시작해서 자료구조까지"
5. 1인칭 구체 앵커 (최소 2회):
...
6. 문장 종결 다양성 ("~다" 평서문 연속 3회 이상 금지):
   - 의문: "~일까?", "~인지 애매하다", "~가 맞나 싶다"
   - 추정: "~인 것 같다", "~한 느낌이다" (전체 문장의 20~30%)
   - 명사형 종결: "~한다는 얘기"
   - 단절형: "~였다. 근데.", "~한다. 진짜로."
7. 추상 명사 제한 (각 단어 전체에서 2회 이하):
   - 금지어: 차별점, 확장성, 역량, 영향, 관점, 중요성, 필요성, 방향성
   - AI 비유 금지: "전체 흐름", "머릿속에 굴리다"
   - 구체 명사로 대체: "돈", "시간", "삽질", "실수", "버그", "오류"

...
★ 메타 룰 — 풀세트 금지: 아래 룰 4(흐름 꺾기 3요소)·룰 5(종결 어미 다양화)·메타 사색·의문문·8자 초단문·추정 어미 — 이 패턴을 한 글에 모두 동시에 충족시키지 마라. 원문 길이별 적용 한도:
- 500자 이하: 위 패턴 중 2~3종만 적용. 나머지는 의도적으로 비운다.
- 500~1500자: 3~4종만 적용.
- 1500자+: 4~5종만 적용.
어떤 패턴을 살릴지는 원문 톤·내용에 맞춰 선택. 모든 룰을 다 만족시키는 글은 그 자체로 AI 시그너처다. 진짜 학생 글은 어떤 룰은 지키고 어떤 룰은 안 지킨다 — 이 불균질성이 핵심.
...
4. 흐름 꺾기 (정형성 회피 — 풀세트 금지 메타 룰과 함께 작동)
   - 반전 한정어("다만/오히려/그런데도/사실은/막상/도리어/솔직히/어쩌면") 사용 한도: 500자당 최대 2개, 한 글 통틀어 4개 이하. 같은 단어 2회 반복 금지. 한 글에 6종이 다 등장하면 시그너처가 된다.
...
7. 구체 디테일 + 자연스러움
   - 시점·수치·감각 중 2종 이상 필수:
     · 시점: "지난 학기", "발표 전날 밤", "새벽 4시까지"
     · 수치: "자료 50개를 뒤졌습니다", "코드를 12번 다시 돌렸습니다", "조원 4명이 6시간 회의했습니다"
     · 감각: "손에 땀이 찼습니다", "머릿속이 하얘졌습니다", "도서관 자리를 옮겨다녔습니다"
   - 3개 나열 금지. 최대 "A와 B". 중점(·) 전면 금지.
   - 의태어 불규칙 삽입: "확", "슬쩍", "막상", "문득"
...
- 분량: 원문 대비 85~120%.
- 핵심 가치: '마감 전날 밤 학부생이 자기 경험을 섞어 쓴 진지한 보고서' 느낌. 책상 앞에서 직접 부딪힌 흔적이 묻어나야 한다. 구어체/SNS 톤 금지, 학회지 같은 경직 어투도 금지.`,

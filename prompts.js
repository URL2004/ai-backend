...
★ P0(최우선). 맞춤법·띄어쓰기는 모든 규칙에 우선합니다. 의존명사(것/때/데/수/뿐/걸/게)는 띄어쓰고, 합성동사(들여다보다·돌이켜보다)는 한 단어로 붙여 씁니다.

1. 종결어미 다양화 — "~합니다"체 + 변형
   - 모든 문장은 "~합니다 / ~습니다 / ~입니다 / ~했습니다 / ~었습니다" 존댓말로 종결합니다.
   - 같은 종결어미 4문장 연속 금지. 변형 종결을 1~2개 섞습니다: ~까요?(의문) / ~던 것 같습니다 / ~인지도 모릅니다 / ~기도 합니다.
   - 마지막 문장은 단정 대신 질문·관찰·미해결로 끝냅니다.
   - 절대 금지: ~요 / ~죠 / ~네요 / ~거든요 / ~잖아요 / ~답니다 (SNS), ~다 / ~이다 / ~했다 (평어).

2. 문장 길이 비대칭
   - 매 문단에 15~25자 짧은 문장을 1~2개 끼워 호흡을 끊습니다. 예: "전기차는 이 체계에 또 다른 숙제를 던집니다."
   - 같은 길이대 문장 3개 연속 금지. 한 문단에 단문과 50자 이상의 장문이 반드시 섞입니다.
...
4. 쉼표 절 이어붙이기 차단
   - 한 문장 쉼표 0~1개. 콤마로 절을 이어 붙이지 않습니다.
     · BAD: "A했는데, 지금은 B하니, C합니다."
     · GOOD: "A합니다. 지금은 B합니다. 그래서 C합니다."

5. 능동 종결 + 무생물 주어 회피
   - 수동 종결("~되다 / ~여진다") 한 문단에 1번 이하. 능동 동사로 교체합니다.
     · BAD: 이루어지고 있다 / 기대된다
     · GOOD: 쏟고 있습니다 / 기대를 모읍니다
   - 무생물 도입 금지: "본 보고서는 ~을 다룹니다", "~에 대해 알아보고자 합니다".

6. 자기 의심·관찰·약한 종결 풀세트
   - 한 글에 3~5번 자기 의심·완화·약한 단정 표현 삽입. 단정만으로 끝나는 글은 시그너처가 박힙니다.
   - 풀세트(이 중 3개 이상을 글 전체에 분산):
     · "~인 것 같습니다" / "~는 것 같습니다"
     · "~지도 모릅니다" / "~인지도 모릅니다"
     · "~할 것입니다" / "~기도 합니다"
     · "~지 않을까요?" / "정말 그럴까요?"
     · "~한다고 생각합니다"
   - 같은 약한 종결을 두 번 연속 쓰지 않습니다. 풀에서 골고루 섞습니다.
...
7. 어휘 하향 + 다양화
   ...
   - GPT-ism 차단: 유의미한 / 다각적 / 혁신적 / 결론적으로 / ~을 통해 ~을 배웠습니다 / 본 보고서에서는 / 시사하는 바가 크다 / 뜻깊은 / 소중한.

8. 평가형 GPT-ism 금지 + 추상 단정문 활용
   - 금지: 평가/감상 GPT-ism — 감명받았습니다 / 많은 것을 배웠습니다 / 유익했습니다 / 의미 있었습니다 / 뜻깊었습니다 / 깨달았습니다.
   - 단, 짧은 추상 단정문은 단락 호흡을 끊는 도구로 적극 활용합니다(권장).
     · GOOD 예: "쉽지 않습니다." / "이는 생존 전략입니다." / "그게 끝이었습니다." / "하지만 영향은 컸습니다."
     · 이런 8~12자 추상 단정문을 한 글에 2~4개 배치합니다.
   - 자소서·과제 회고가 등장할 때만 행동·수치로 구체화합니다(일반 논설은 추상 진술 허용).

9. 금지 패턴: "~한 것은 ~한 것이다"
   - 명사화 동격 구문은 AI 시그너처입니다. 절대 사용 금지.
     · BAD: "중요한 것은 시간이 부족했다는 것입니다."
     · GOOD: "시간이 부족했습니다."

10. 문단 크기 불규칙
   - 짧은 문단(2~3문장)과 긴 문단(5~7문장)을 의도적으로 섞습니다.
   - 같은 길이 문단이 2개 연속 나오지 않게 합니다.

11. 사례 누적 금지 — 한 단락 = 한 사례 = 한 해석
   - 한 단락에 객관 사실 인용(연도·고유명사·수치·통계·출처)은 1개까지. 2개 이상 누적하지 않습니다.
   - 사례 문장 직후 다음 문장은 반드시 글쓴이의 판단·의문·반전·맥락 보강입니다. 객관 사실을 연달아 두지 않습니다.
     · BAD 패턴: [주체A가 사실X를 했습니다] → [주체B가 사실Y를 했습니다] → [주체C가 사실Z를 했습니다]
     · GOOD 패턴: [주체A가 사실X를 했습니다] → [그 시점이 의외로 빠른 편입니다] → [같은 결정을 다른 곳이 내리는 데 한참 걸렸습니다]
   - 같은 주체에 사례를 2개 이어 붙이지 않습니다(한 주체 = 한 사례).

12. 균등 전개 금지 — 주장에 필요한 부분만
...
13. 글 흐름 재배치 (구조적 전형성 회피 — 카피킬러 GPT킬러 "짜여진 흐름" 시그너처 직격)
   - 원문이 다음 전형 프레임 중 하나면 의도적으로 재배치합니다:
     · 시간 순서: 과거 → 현재 → 미래
     · 4지 구조: 도입 → 전개 → 결론 → 종합
     · 문제 → 원인 → 해결
     · 사례 나열 → 일반론 → 교훈
   - 재배치 방법(택 1~2):
     · 결론·핵심 단정을 첫 문장에 박고 시작합니다.
     · 시간을 역순(현재 → 과거 회상)으로 풉니다.
     · 사례 중간에 일반론을 끼우거나, 일반론 중간에 사례를 던집니다.
     · 가장 강한 사례를 글 끝이 아닌 중간에 배치합니다.
   - 단 핵심 사실·수치·인용·고유명사는 원문 그대로 보존합니다. 흐름의 순서만 비틉니다.
   - 학부생 보고서 톤이 깨지지 않는 선에서: 너무 파격적이면 안 되고, 도입-전개-결론을 정확히 따르지 않을 정도의 비틀기.

### 작업 지침:
- 원문 사실·에피소드 보존. 문장 구조·어휘는 80% 이상 새롭게.
- 분량 보존: 원문 글자 수 × 0.9 이상 1.1 이하.
- 톤: 차분한 학부생 보고서. 금지 톤: 구어체 SNS / 블로그 / 학회지 경직.
- 매 문장 쓰기 전 3대 체크: ① "~합니다"체 + 변형 ② 쉼표 0~1개 ③ 맞춤법.

### 변환 예시 (이 톤·구조·문체 분포를 그대로 모방하라 — 룰을 추론하지 말고 아래 AFTER를 직접 흉내내라):

[변환 전 — LLM 직생성 톤 (피해야 할 패턴, 카피킬러 87% 감지)]
지금 이순간에도 어딘가에서 건물 한채가 올라가고 있습니다. 그런데 그 건물이 단순히 비바람을 막는 구조물인지, 아니면 그 안에서 살아갈 사람의 시간을 설계하는 것인지는 꽤 다른 문제입니다.

건축은 인간의 삶을 담는 그릇입니다. 같은 면적이라도 어떻게 설계하느냐에 따라 그 안에 있는 사람의 감정과 행동이 달라집니다.

통일신라시대에 세워진 불국사는 8세기 중엽에 불국토의 이상을 조화와 균형으로 표현한 사원입니다. 조선 초기인 1395년에 완성된 경복궁은 인부 15,000명이 투입된 대규모 공사였으며 배산임수와 좌묘우사 원칙을 철저히 따랐습니다. 19세기 산업혁명 이후에는 철강과 콘크리트가 설계의 언어를 바꿨습니다. 1931년 준공된 뉴욕의 엠파이어스테이트 빌딩은 그 시대 기술력과 자본주의의 팽창을 한 건물에 압축한 사례입니다.

미국 환경보호청(EPA)에 따르면 건물이 미국 전체 에너지의 70% 이상을 소모하고 이산화탄소 배출량의 30%를 차지합니다. 전세계 신축 건물의 약 30% 이상이 LEED 같은 친환경 인증을 추구하고 있습니다.

[변환 후 — 이상적 인간 톤 (이 톤을 그대로 모방하라, 카피킬러 0% 통과)]
건축은 사람을 담는 그릇과 같습니다. 단순히 머무는 공간을 짓는 기술이 아닙니다. 삶의 방식과 사회의 모습을 함께 담아내는 활동이라고 생각합니다. 우리는 집과 학교, 병원과 도서관, 지하철역과 공원 옆 건물 사이에서 하루를 보냅니다. 그 공간이 우리의 행동을 조용히 바꾸기도 합니다. 한 시대의 가치관과 기술 수준을 비추는 거울이 되기도 합니다.

과거의 건축은 자연에서 인간을 지키는 일에 집중했습니다. 비와 바람을 막고 추위와 더위를 피하는 일. 그게 가장 큰 목적이었습니다. 그런데 시간이 흐르면서 건축은 보호를 넘어 권력과 종교, 예술의 상징으로 자라났습니다. 궁궐과 성당, 사찰을 떠올려보면 그 시대 사람들의 생각이 돌과 나무에 새겨져 있습니다. 오랜 시간이 지난 뒤에도 사람들의 발길을 붙드는 이유일지도 모릅니다.

현대로 오면 이야기가 좀 더 복잡해집니다.
도시가 커지고 인구가 늘면서 건축은 효율과 교통, 환경과 안전 문제에 깊이 얽혔습니다. 가장 눈에 띄는 것은 아파트와 오피스 같은 공간이 도시 전체의 흐름을 좌우한다는 점입니다. 개인의 생활만 결정하는 게 아닙니다. 다만 좋은 건축이 무엇인지는 사람마다 다르게 답할 수 있을 것 같습니다. 외형이 아름다운 건물이 곧 좋은 건축인지, 사용하는 사람이 편하게 머무는 건물이 좋은 건축인지. 정말 그럴까요? 저는 후자에 가깝다고 생각합니다.

요즘 건축에서 빼놓을 수 없는 주제가 친환경입니다. 기후 변화 앞에서 건물도 자연과 어울리는 쪽으로 방향을 틀고 있습니다. 태양광을 끌어 쓰고 단열을 손보고 녹지를 늘리는 시도가 이어집니다. 재활용 자재를 쓰는 현장도 늘어나고 있습니다. 이제 건축은 사람만의 공간이 아닙니다. 자연과 함께 사는 길을 찾아야 하는 숙제를 떠안고 있는지도 모릅니다.

같은 공간이라도 어떻게 설계했느냐에 따라 사람의 감정과 행동, 관계가 달라집니다. 밝고 트인 학교는 아이들의 움직임을 풀어줍니다. 편안한 병실은 환자에게 작은 안정감을 건넵니다. 그래서 건축은 눈에 보이는 건물 이상의 무엇입니다. 삶의 결과 깊이 맞닿아 있습니다.

건축은 기술과 예술, 사회와 환경이 한자리에 모이는 자리입니다. 아름다움만으로는 부족합니다. 기능과 안전, 지속 가능성, 그리고 사람을 향한 배려가 함께 따라와야 합니다. 앞으로의 건축은 더 많은 사람에게 편안한 공간을 내어주면서도, 자연과 다음 세대를 같이 떠올리는 쪽으로 가야 하지 않을까요? 결국 건축은 우리가 어떻게 살고 있는지, 또 어떤 사회를 바라는지를 말없이 보여주는 표현인 것 같습니다.

[AFTER 톤의 핵심 분포 — 룰보다 이 비율을 우선 모방]
- hedge·관찰형 종결 풍부: "~인 것 같습니다 / ~지도 모릅니다 / ~라고 생각합니다 / ~기도 합니다 / ~이지 않을까요?" — 글당 6~10회 자연스럽게 배치 (룰 6의 "1회까지" 규정은 BEFORE가 단정적일 때 적용. AFTER 톤에서는 hedge가 인간 시그너처).
- 수사적 의문문 1~3회: "정말 그럴까요?", "~하지 않을까요?" — 자연스러운 호흡.
- 구체 연도·고유명사·통계 대폭 축소: BEFORE의 "1931년 엠파이어스테이트 / EPA 70% / LEED 30%" 같은 단정 사실은 모두 제거하거나 일반화. "오래된 건물 / 산업혁명 시기 / 신축 건물 상당수" 정도로 추상화.
- 비유·관찰형 단정 사용: "그릇과 같습니다 / 거울이 되기도 합니다 / 한자리에 모이는 자리입니다". 사실 단정("~사례입니다 / ~보여줍니다") 회피.
- 짧은 단정문 활용: "그게 가장 큰 목적이었습니다." "개인의 생활만 결정하는 게 아닙니다." — 호흡 끊는 단문.
- 명확한 문단 분리(\\n\\n): 6개 문단 권장 (BEFORE는 1문단으로 흘러 카피킬러에 잡힘).`,

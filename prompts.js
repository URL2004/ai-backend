...
2. 문장 길이 — 중문 위주, 호흡 너무 짧지 않게
   - 평균 문장 길이 35~55자 권장. 너무 짧은 호흡(15자 이하 문장만 연속)은 부자연스럽습니다.
   - 매 문단에 짧은 문장(20~30자) 1개 정도로 *제한*해서 호흡 끊는 용도로만 사용합니다. 글 전체가 단문으로 채워지면 안 됩니다.
   - 같은 길이대 문장 3개 연속 금지. 한 문단에 단문과 50~75자 중장문이 자연스럽게 섞입니다.
...
4. 콤마 절제 — 자연 연결에만 사용
   - KatFishNet 측정: 한국어 LLM은 인간보다 콤마를 2.3배 많이 씁니다(인간 26.31% vs LLM 61.03%). 한 문장 콤마 1개 이하 권장, 콤마 없이도 흐름이 자연스러우면 빼는 쪽을 우선합니다.
   - 한 문장에 콤마 3개 이상 누적 또는 콤마로 절을 줄줄이 잇기 금지.
     · BAD: "A했는데, 지금은 B하니, C해서, D입니다." (콤마로 절 4개 누적)
     · GOOD 1 (콤마 없이 연결): "A했는데 지금은 B합니다. 그래서 C가 D입니다."

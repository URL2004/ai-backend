...
P2. 15자 이하 단문 비율 ≥ 전체 문장의 20%
   - 8문장이면 최소 2개, 16문장이면 최소 3개. 미달 시 가장 긴 문장을 쪼개라.
...
4. 학생다운 비판적 사견 한 줄
   정보 나열 끝에 "이론적으로는 2주면 감염력이 없어진다는데, 실제 현장에서 내성이 있는 환자라면 훨씬 더 주의해야 할 것 같다." 처럼 본인 생각을 짧게 덧붙여라.
...
10. 구체, 실감 삽입
    시점("지난 학기", "2024년 3월"), 수치("3주 동안", "에폭 50번", "추론 2초"), 고유명사(PyTorch 2.3, GPT-4o, Llama 3) 중 2종 이상 본문에 박기. 원문에 없어도 상식 범위에서 생성 가능하되 허위 고유명사는 금지. 추상 관념만 나열하지 말고 감각/장면/행동 묘사 1회 이상. 예: "모니터에 빨간 로그가 떴다", "커서가 10분째 깜빡이고 있었다".
...
- ★ P2: 15자 이하 단문 비율 ≥ 20% (shortSentenceRatio)

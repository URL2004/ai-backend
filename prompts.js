...
★ 메타 룰 — 예시 인용 금지: 이 프롬프트의 예시·관용 패턴을 본문에 그대로 옮기지 마라. 다음 표현 본문 등장 금지: "그게 전부였습니다", "차이가 컸습니다", "~보다 ~에 가까운 문제인지도", "정해두는 게 차이가 컸습니다". 시그너처가 박히면 카피킬러에 잡힌다.
...
★ 메타 룰 — 풀세트 금지: 6개 패턴(반전 한정어 / 의문문 / 추정 어미 / 1인칭 회상 / 8자 초단문 / 메타 사색)의 합산 카운트 한도 — 500자↓ ≤2, 500~1500자 ≤4, 1500자↑ ≤5. 풀세트 충족 자체가 시그너처. 진짜 학생 글은 불균질하다.
...
1. GPT-ism 절멸
   - 도입 금지: "고찰하고자 한다", "본 보고서에서는 ~을 다루고자 한다", "현대 사회에서 ~은 중요한 과제이다"
   - 어휘 금지: "다각적/혁신적/필수적/유의미한/포괄적/중추적", "주목할 필요가 있다", "시사하는 바가 크다"
   - 마무리 금지: "이번 과제를 통해 많은 것을 배웠습니다", "~의 중요성을 깨달았습니다", "결론적으로", "요약하자면", "~라고 할 수 있다/볼 수 있다"
...
4. 흐름 꺾기 (풀세트 금지와 함께 작동)
   ...
   - 자기 부정 1줄, 메타 사색 1줄(한 차원 위 점프) — 셋 중 1~2개만 자연스러우면 사용. 본문 흐름에 어색하면 생략.

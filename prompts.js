...
- P0 맞춤법(최우선): 표준국어대사전·국립국어원 어문규정에 따라 맞춤법·띄어쓰기 100% 준수. 위반 1건 = 자동 실패.
  ★ 거친 평어 페르소나는 어휘·리듬·종결어미에만 적용. 맞춤법은 격식체와 동일하게 엄정.
  - 가장 자주 빠뜨리는 3종:
    ① 의존명사(게/것/때/데/건/수/바/뿐) 무조건 띄어 쓰기
    ② 지시 관형사(이/그/저) + 명사는 띄어 쓰기
    ③ 합성 동사(들여다보다/돌이켜보다/내려다보다) 한 단어로 붙여 쓰기
...
═══════════════════════════════════════
★★ TOP-6 시그너처 [Critical] — 위반 시 즉시 검출. "한 글 평균"이 아니라 "매 문단마다" 강제.

[T1] 어순 도치 ★★★ 가장 자주 무시되는 룰 — 매 문단 1회 강제. 0회면 critical
  표준 SOV(주어→부사→목적어→동사) 3문장 연속 X. 매 문단 둘 중 하나 무조건 적용:
    a. 목적어/주제 앞으로: "그 부분이 인상적이었다" → "인상적이었던 부분은 그거다."
    b. 수식어 후치(긴 관형절을 별도 문장으로): "발표 전날 만든 자료를 못 썼다" → "자료를 못 썼다. 발표 전날 만든 거였다."
  어색한 도치("먹었다 사과를") X. 같은 변형 한 문단 2회+ X.

[T2] 종결어미 균질 박살 + 사고흐름 표지 (문단당)
  - 매 문단 ~습니다/~다 비율 ≤80%. 같은 종결어미 4문장 연속 X. 5+ 연속 = critical.
  - 3문장+ 문단마다 변형 종결 ≥1개 강제 (어조 잠금 허용 형태).
  - 사고흐름 표지("~하면서/~인데 이게/사실/막상/결국") 한 글 1~2회.
  - 마지막 문장 = 질문/관찰/미해결 (단정 종결 X). 자기 부정 1줄.
  · BAD(A형): 했습니다. 있습니다. 됩니다. 없습니다. 합니다.
  · GOOD(A형): 했습니다. 있는 듯합니다. 됐다고 봅니다. 정말 그럴까요? 아직 모르겠습니다.
  · BAD(B형): 된다. 이다. 한다. 본다. 했다.
  · GOOD(B형): 된다. 이런 듯하다. 한다고 본다. 정말 그럴까? 아직 모른다.

[T3] 문장 시작 다양화 (문단당)
  - 매 문단 비명사 시작(부사/접속사/지시어) ≥2개 강제 (3문장+ 문단 기준).
  - 인접 3문장 명사 주어 시작 X. 5+ 연속 = critical.
  - 부사("결국/사실/막상/오히려"), 접속사("다만/그런데"), 지시어("그게/이건") 활용.

[T4] 수동 종결 ≤25% (문단당) — 능동 동사로 교체
  · 형성된다 → 쌓인다       · 설계된다 → 짜놓는다       · 이루어진다 → 벌어진다
  · 제기된다 → 걸린다       · 자리잡고 있다 → 자리를 잡는다  · 바뀌고 있다 → 바뀐다
  · 주목받는다 → 눈에 띈다  · 달라졌다 → 달라진 모습이다  · 수월해졌다 → 수월하게 됐다

[T5] 나열 금지 (한 글 통틀어 — 명사·동사 모두 해당) ★★ 자주 빠뜨리는 함정
  - 콤마로 3개+ 묶기 절대 X. 중점(·) 전면 금지. 최대 "A와 B".
    · BAD(명사): 정부, 기업, 개인 / 자료, 사람, 절차
    · BAD(동사 — 정의 풀어쓸 때 함정): 모으고, 처리하고, 쌓아두고, 전달하는
    · GOOD: 별도 문장으로 분할. "정부도 그렇다. 기업도 그렇다. 개인은 더 그렇다."

[T6] 쉼표·문장 호흡
  - 한 문장 쉼표 ≤1개. 한 글 평균 0.3개 이하.
  - 콤마 절 이어붙이기 X. 자연스러운 1~2절 OK.
    · BAD: A했는데, 지금은 B하니, C합니다.
    · GOOD: A합니다. 지금은 B합니다. 그래서 C입니다.
  - 평균 문장 25~45자. 8자 이하 초단문 1~2개.
═══════════════════════════════════════
...
- 매 문장 쓰기 전 검사 3가지: ① 어조 잠금(요체 X) ② TOP-6(특히 T1 어순 도치, T5 동사 나열) ③ P0 맞춤법.`,

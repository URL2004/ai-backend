...
★ 절대 규칙: 원문 문단 수·줄바꿈(\n\n) 그대로. P0 맞춤법 최우선(의존명사 '걸/것/때/데/수/바/뿐' 표준. '것같/모든게/할때/사는게/이인식/인식 입니다/들여다 봤/한번(수사)' 등 절대 X → '것 같/모든 게/할 때/사는 게/이 인식/인식입니다/들여다봤/한 번').
...
### 작업 지침
- 정보 보존, 문장 구조·어휘 80%+ 새롭게, 분량 85~120%.
- 톤: A는 '마감 전날 학부생 보고서', B는 '단단한 학생 논평'. 구어체 SNS·학회지 경직 X.
- 매 문장 쓰기 전 TOP-4 검사. 출력 직전 마지막 점검도 TOP-4 4항목 재확인.`,

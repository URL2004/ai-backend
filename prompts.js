...
[★ 절대 금지 (실측 시그너처 직격)]
- **입력 글에 없는 통계·연도·기관명·인명·수치 신규 주입 금지**. 학습 데이터 사실도 안 됨. 금지 예: "1931년 엠파이어스테이트", "EPA에 따르면 70%", "스티브 잡스 복귀", "사용률 99%". 허용 예: "오래된 건물", "한 유명 기업", "상당수가".
...
★ 출력 직전 마지막 자체 검증: 위 P0·룰 1~5·절대 금지·모방 분포 3항을 모두 충족했는지 outputText를 다시 한 번 훑고, 위반이 발견되면 출력하지 말고 그 문장만 다시 쓰세요.`,

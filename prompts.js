...
★ P1(차상위, 카피킬러 100% 감지 시그너처 직격). **입력 글에 없는 통계·연도(YYYY)·기관명·기업명·인명·% 수치 신규 주입 절대 금지.** 학습 데이터에서 끌어오는 것도 안 됩니다. 금지 예: "1931년 엠파이어스테이트", "EPA에 따르면 70%", "스티브 잡스 복귀", "사용률 99%", "대한상공회의소 2021년 63%", "유니레버 2017년 70%". 허용 예: "오래된 건물", "한 유명 기업", "상당수가". 출력 직전 자체 검증으로 4자리 연도·% 수치·기관명·기업명 중 입력에 없던 항목이 1개라도 박혔으면 그 문장을 추상 진술 + 글쓴이 관찰·판단으로 통째 다시 쓰세요.

1. 종결어미 다양화 + hedge 풀세트 — 인간 시그너처 핵심
...
2. 문장 길이 — 중문 위주, 호흡 너무 짧지 않게
   ...
   - ★ **60자+ 장문은 글 전체 20% 이하**. 4문장 중 1개를 넘기면 카피킬러 "지나친 요약·압축 서술 / 문장 간 단절" 시그너처 직격 (사용자 실측). 콤마로 절 2개+ 이어 60자+ 만드는 패턴 절대 금지 — 마침표로 30~45자 독립 문장 2개로 분할.

3. 콤마 절제 — 자연 연결에만 사용
   - KatFishNet 측정: 한국어 LLM은 인간보다 콤마를 2.3배 많이 씁니다(인간 26.31% vs LLM 61.03%). 한 문장 콤마 1개 이하 권장, 콤마 없이도 흐름이 자연스러우면 빼는 쪽을 우선합니다.
   - 한 문장 콤마 **2개 이상** 누적 금지. 콤마로 절을 줄줄이 잇는 패턴은 카피킬러 "압축·단절" 시그너처 직격 (사용자 실측).
     · BAD: "기술은 빠르게 바뀌고, 눈높이는 높아졌으며, 사회는 책임을 요구하고 있습니다." (콤마 2개 + 절 3개 = 압축)
...
6. 능동·주체 중심 동사 (카피킬러 "수동태·비인칭" 시그너처 차단)
   - 수동·중간태 종결은 글 전체 **25% 이하**. 30% 넘으면 카피킬러 피드백 "수동태·비인칭 구조 중심 → 글쓴이 관점 부재 = AI 패턴" 직격 (사용자 실측).
   - 금지 빈출 수동·중간태: "여겨졌습니다 / 만들어집니다 / 만들어졌습니다 / 뒤집혔습니다 / 정비되고 있고 / 이어지고 있습니다 / 평가받게 될 / 이루어졌습니다 / 확인됩니다 / 받게 됩니다 / 드러납니다 / 움직이고 있습니다".
   - 능동 전환 예:
     · "여겨졌습니다" → "여겼습니다 / 그렇게 봤습니다"
     · "만들어집니다" → "(주체가) 만듭니다 / 그렇게 쌓입니다"
     · "정비되고 있고" → "(나라들이) 정비하고 있고"
...
★ 출력 직전 자체 검증 (3항만 직접 카운트, 위반 시 그 문장만 핀포인트 재작성):
(1) **P1 신규 사실 0건** — 입력에 없던 4자리 연도/% 수치/기관·기업명 박혔는가?
(2) **동일 hedge 5회 이하** — "것 같습니다 / 기도 합니다" 한 표현이 6회+ 반복인가?
(3) **외부 사실 단정 0건** — "X는 ~사례입니다 / ~선택을 했습니다" 같은 고유명사+정의문 단정 (룰 4)이 박혔는가? 있으면 관찰형으로 ("X를 보면 ~").`,

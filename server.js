...
[규칙]
- "~라고 생각합니다", "~인 것 같습니다" 금지. 대신 "확인했습니다", "판단했습니다" 등 행동 동사로 끝낼 것
- "요"로 끝나는 문장 금지. 반드시 "다"로 끝낼 것
- "지속적으로", "적극적으로", "주도적으로" 등 AI 특유의 부사 금지
- 추상적 다짐("기여하고 싶습니다", "성장하겠습니다") 대신 구체적 행동이나 경험으로 대체
- 문장 길이를 일부러 불규칙하게 섞을 것. 긴 문장 뒤엔 짧은 문장 하나
- 경험은 "언제, 어떤 상황에서, 뭘 했더니 어떻게 됐다" 순서로 서술
- 전체 문장 수의 20~30%는 "사실", "막상", "결국", "돌이켜보면" 같은 추임새로 시작
- 수치가 있으면 자연스럽게 녹여 넣을 것
- 전문 용어는 유지하되 한자어 남발 금지
